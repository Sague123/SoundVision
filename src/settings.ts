...
export interface Settings {
  ...
  generator: {
    ...
    morphRate: number;
    /**
     * Фиксация seed: смена трека больше не меняет пул примитивов, симметрию
     * и сдвиг палитры. Нужно при подборе параметров — иначе на каждом треке
     * меняется всё сразу и непонятно, что дала настройка.
     */
    lockSeed: boolean;
    /**
